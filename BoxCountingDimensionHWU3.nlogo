...
to setup
  ...
  if (fractal-example = "koch-curve" or fractal-example = "cantor-set" or fractal-example = "another-curve") [
    set x-cor -250
    set y-cor -200
    set divisions 3
    set initial-length 165
  ]
  if (fractal-example = "sierpinsky-curve") [
    set x-cor -250
    set y-cor -200
    set divisions 2
    set initial-length 250
  ]
  if(fractal-example = "levy-curve" or fractal-example = "dragon-curve") [
    set x-cor -100
    set y-cor 0
    set divisions sqrt 2
    set initial-length 150
  ]
...
to iterate
  ...
  [
    ...
    t  walk l 120
    t walk d ;l-system
    set divisions 2 ;the factor by which the length decreases
  ...
  if fractal-example = "another-curve"
  [
    ask patches [set pcolor black] ; clears screen
    ask turtles [
      set new? false ]
...
to box-counting-go
   ...
   set initial-length 100
    ...
    set iterations-to-go 1091 - iteration
    set old-box-count 0
...
200
Another curve
ca\nset fractal-example \"another-curve\"\nsetup
NIL
1
T
OBSERVER
...
200
Sierpinsky curve
ca\nset fractal-example \"sierpinsky-curve\"\nsetup
NIL
1
T
OBSERVER
